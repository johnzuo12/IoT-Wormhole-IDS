...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype395</identifier>
      <description>Cooja Mote Type #1</description>
      <source>[CONFIG_DIR]/../contiki2.7/examples/ipv6/simple-udp-rpl/unicast-receiver.c</source>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/../contiki2.7/examples/ipv6/simple-udp-rpl/unicast-sender.c</source>
      <commands EXPORT="discard">make unicast-sender.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/../contiki2.7/examples/ipv6/simple-udp-rpl/unicast-sender.sky</firmware>
    ...
    <mote>
      <interface_config>
        ...
        <x>102.33278103424499</x>
        <y>16.14444435260038</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype395</motetype_identifier>
    </mote>
    <mote>
      <breakpoints />
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspPosition
        <x>77.44457326294365</x>
        <y>47.04958147520533</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.656350060888369 0.0 0.0 3.656350060888369 -74.16447016543778 6.970259908360718</viewport>
    </plugin_config>
    <width>670</width>
    <z>0</z>
    <height>720</height>
