...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype621</identifier>
    ...
    <mote>
      ...
      <motetype_identifier>mtype621</motetype_identifier>
    </mote>
    <mote>
      <breakpoints />
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspPosition
        <x>-39.18427244342866</x>
        <y>31.305616240218818</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspPosition
        <x>151.4825740518537</x>
        <y>65.7454392982672</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspPosition
        <x>93.0846132142934</x>
        <y>120.15037717257553</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspPosition
        <x>25.203222839009626</x>
        <y>76.72625244721017</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspPosition
        <x>62.637813119497004</x>
        <y>1.8570718862354163</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspPosition
        <x>101.56978701120387</x>
        <y>-48.05571515441442</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.003494613886383 0.0 0.0 2.003494613886383 133.50547878946594 256.2793664783275</viewport>
    </plugin_config>
    <width>547</width>
    <z>1</z>
    <height>720</height>
