...
#define x_loc 15
#define y_loc 51
#define Neighbor_queue 15
#define node_range 100
#define Nodes_in_network 24
...
#define one_node_set_time 9 //2.6 min
#define send_tym 224
#endif

#if Nodes_in_network > 20 && Nodes_in_network <= 30
#define one_node_set_time 6 //3min
#define send_tym 60//300
#endif
 
#if Nodes_in_network > 30 && Nodes_in_network <= 40
#define one_node_set_time 4//3.33 min
#endif


#define rssi_wait_tym 20 + 6*Nodes_in_network 
#define reset_tym 20 + 7*Nodes_in_network +20
